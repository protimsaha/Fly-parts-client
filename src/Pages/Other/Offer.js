        ...
        <div>
            <div className="hero lg:px-12 min-h-[60vh]  bg-base-100 ">
                <div className="hero-content flex-col lg:flex-row">
                    <div>
                        <h1 className="text-5xl font-bold uppercase text-orange-500 ">May offer</h1>
                        <p className="py-6 shrink text-3xl text-slate-600">Our lucky customer will get a free service from us</p>
                        ...
                        <button className="btn btn-accent mt-3">Grab now</button>
                    </div>
